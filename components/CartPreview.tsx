...
export const CartPreview: React.FC<{ isOpen: boolean; onClose: () => void }> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed md:absolute top-16 right-0 w-full md:w-96 bg-white h-[calc(100vh-4rem)] md:h-auto md:max-h-[32rem] overflow-auto rounded-t-lg md:rounded-lg shadow-xl">
      <div className="sticky top-0 bg-white border-b px-4 py-3 flex justify-between items-center">
        <h3 className="text-lg font-bold text-green-800">{t.cart.title}</h3>
        <button 
          onClick={onClose}
        ...
        <>
          ...
          <div className="sticky bottom-0 bg-white border-t p-4">
            <div className="flex justify-between items-center mb-4">
              <span className="font-bold text-green-800">{t.cart.total}:</span>
